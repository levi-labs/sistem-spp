            ...
            <div class="container mb-5 mt-3">
                <div class="row d-flex align-items-baseline">
                    ...
                    <div class="col-xl-3 float-end d-print-none">
                        {{-- href="{{ url('/print-cart/' . $result->invoice) }}" --}}
                        <button class="btn btn-light text-capitalize border-0" data-mdb-ripple-color="dark"
                            onclick="window.print()" target="_blank"><i class="fas fa-print text-primary"></i>
                            Print</button>
                ...
                <div class="container">
                        ...
                        <div class="col-xl-8">
                            <ul class="list-unstyled">
                                <li class="text-muted">To: <span
                                        style="color:#5d9fc5 ;">{{ auth()->user()->siswas->nama }}</span></li>
                                <li class="text-muted"> Street :&nbsp;
                                    {{ auth()->user()->siswas->alamat != null ? auth()->user()->siswas->alamat : '' }}</li>
                                <li class="text-muted">Indonesia</li>
                                <li class="text-muted"><i class="fas fa-phone"></i>
                                    {{ auth()->user()->siswas->no_hp != null ? auth()->user()->siswas->no_hp : '' }}</li>
                            </ul>
                        </div>
                        <div class="col-xl-4">
                                    ...
                                    <tr>
                                        ...
                                        @if ($result->status == 'UNPAID')
                                            <td><a href="{{ url('/delete-checkout/' . $dt->id) }}"
                                                    class="btn btn-danger btn-sm d-print-none">
                                                    Hapus</a></td>
                                        @else
                                            <th scope="col"></th>
                                        @endif
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-2 d-print-none">
                            @if ($result->status == 'UNPAID')
        ...
        payButton.addEventListener('click', function() {
            ...
            window.snap.pay('{{ $snapToken }}', {
                onSuccess: function(result) {
                    ...
                    window.location.href = "/daftar-sudah-dibayar";
                    console.log(result);
                },
