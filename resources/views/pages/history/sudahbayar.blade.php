        ...
        <div class="col-md-12 grid-margin stretch-card ">
            <div class="card d-print-none">
                <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" action="{{ url('/print-history-sudah') }}" autocomplete="off">
                        @csrf
                        ...
                        <a href="/history-sudah" onclick="window.location.reload()" class="btn btn-light">Cancel</a>
                    </form>
                </div>
            </div>
